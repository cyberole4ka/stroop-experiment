...
async function quitPsychoJS(message, isCompleted) {
  ...
  try {
    const response = await fetch("https://script.google.com/macros/s/AKfycbwt00YEDUbC5Cu7bbF5F_f9yPHJpzHa9pNors5O2bqW9P6kLCaK4t3-e9UcYaxGtnwjkg/exec", {
      method: "POST",
      body: csvContent,
      headers: { "Content-Type": "text/plain" } // важно: text/plain, чтобы обходить CORS
    });
